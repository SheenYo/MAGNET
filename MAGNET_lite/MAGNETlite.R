...
#   .libPaths("./tmpRlib")
#   BiocManager::install(setdiff(packages2_2, rownames(installed.packages(lib.loc="./tmpRlib"))),site_repository="http://bioconductor.org/packages/3.9/bioc",lib="./tmpRlib",ask=FALSE,dependencies=TRUE)
# } 
